...
from file_query.api.context import get_context_by_engine, ExecutionContext, ExecutionContextManager

from file_query.api.core.config import BasicConfig, Configs
from file_query.api.core.log import get_logger
from file_query.api.utils.fast_api_utils import _repeat_every
...
def init_routes(configs: Configs, basic_config: BasicConfig):
    from file_query.api.endpoint.endpoint import (
        get_response_model,
        create_config_endpoint,
    )
    from file_query.api.endpoint.detail_endpoint import create_detailed_meta_endpoint
    from file_query.api.endpoint.sql_endpoint import create_sql_endpoint
    from file_query.api.core.schema_cache import get_schema_cached
    ...
    with ExecutionContextManager(
        ...
        for config in configs:
            ...
            try:
                from file_query.api.core.datasource import Datasource
